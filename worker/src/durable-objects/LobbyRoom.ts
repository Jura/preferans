/**
 * Minimal Env interface for LobbyRoom – only DB is needed here.
 * GAME_ROOM and LOBBY_ROOM are not required because LobbyRoom only
...
/**
 * Message types sent to lobby clients.
 * NOTE: These are intentionally kept local to this worker module.
 * The SvelteKit app defines equivalent types in src/lib/types/preferans.ts.
 * They cannot be shared because the worker and the Pages app compile
 * independently with separate tsconfig files.
 */
